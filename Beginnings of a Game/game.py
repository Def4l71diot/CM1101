...
def normalise_input(user_input):
    ...
    punct_filtered = remove_punct(user_input)
    space_filtered = remove_spaces(punct_filtered)
    normalised = space_filtered.lower()
...
def print_menu(exits):
    ...
    for key in exits:
        exit_room_name = exit_leads_to(exits, key)
        print_menu_line(key, exit_room_name)
...
def menu(exits):
    ...
    while True:
        ...
        direction = normalise_input(user_input)
